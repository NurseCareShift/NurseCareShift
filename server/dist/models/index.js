...
exports.Session = exports.Post = exports.Profile = exports.User = void 0;
...
User_1.default.hasMany(Post_1.default, { foreignKey: 'userId', as: 'posts', onDelete: 'CASCADE' });
Post_1.default.belongsTo(User_1.default, { foreignKey: 'userId', as: 'user', onDelete: 'CASCADE' });
